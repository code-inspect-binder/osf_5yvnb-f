...
#define NTRIALS_POS	(NTRIALS / (VINGER * AANTAL))	//24
#define NBLOKTRIALS_POS	(NTRIALS_POS / BLOK_POS)	//12
...
struct{
	...
	int aantal;	//0 tot 4 handen die beweging maken
