...
//FIXATIE
	...
	if(oefen[i].aantal == 1){
		if(oefen[i].vinger == wijs_oefen){
			if(oefen[i].pos == 1){
				map = ts5_read_bitmap("Stimuli/W/1mov/W_1mov_pos1_neutr.png");
			}else if(oefen[i].pos == 2){
				map = ts5_read_bitmap("Stimuli/W/1mov/W_1mov_pos2_neutr.png");
			}else if(oefen[i].pos == 3){
				map = ts5_read_bitmap("Stimuli/W/1mov/W_1mov_pos3_neutr.png");
			}else if(oefen[i].pos == 4){
				map = ts5_read_bitmap("Stimuli/W/1mov/W_1mov_pos4_neutr.png");
			}		
		}else{
			if(oefen[i].pos == 1){
				map = ts5_read_bitmap("Stimuli/P/1mov/P_1mov_pos1_neutr.png");
			}else if(oefen[i].pos == 2){
				map = ts5_read_bitmap("Stimuli/P/1mov/P_1mov_pos2_neutr.png");
			}else if(oefen[i].pos == 3){
				map = ts5_read_bitmap("Stimuli/P/1mov/P_1mov_pos3_neutr.png");
			}else if(oefen[i].pos == 4){
				map = ts5_read_bitmap("Stimuli/P/1mov/P_1mov_pos4_neutr.png");
			}			
		}
	}else if(oefen[i].aantal == 2){
		if(oefen[i].vinger == wijs_oefen){
			if(oefen[i].pos == 1){
				map = ts5_read_bitmap("Stimuli/W/2mov/W_2mov_pos1_neutr.png");
			}else if(oefen[i].pos == 2){
				map = ts5_read_bitmap("Stimuli/W/2mov/W_2mov_pos2_neutr.png");
			}else if(oefen[i].pos == 3){
				map = ts5_read_bitmap("Stimuli/W/2mov/W_2mov_pos3_neutr.png");
			}else if(oefen[i].pos == 4){
				map = ts5_read_bitmap("Stimuli/W/2mov/W_2mov_pos4_neutr.png");
			}else if(oefen[i].pos == 5){
				map = ts5_read_bitmap("Stimuli/W/2mov/W_2mov_pos5_neutr.png");
			}else if(oefen[i].pos == 6){
				map = ts5_read_bitmap("Stimuli/W/2mov/W_2mov_pos6_neutr.png");
			}
		}else{
			if(oefen[i].pos == 1){
				map = ts5_read_bitmap("Stimuli/P/2mov/P_2mov_pos1_neutr.png");
			}else if(oefen[i].pos == 2){
				map = ts5_read_bitmap("Stimuli/P/2mov/P_2mov_pos2_neutr.png");
			}else if(oefen[i].pos == 3){
				map = ts5_read_bitmap("Stimuli/P/2mov/P_2mov_pos3_neutr.png");
			}else if(oefen[i].pos == 4){
				map = ts5_read_bitmap("Stimuli/P/2mov/P_2mov_pos4_neutr.png");
			}else if(oefen[i].pos == 5){
				map = ts5_read_bitmap("Stimuli/P/2mov/P_2mov_pos5_neutr.png");
			}else if(oefen[i].pos == 6){
				map = ts5_read_bitmap("Stimuli/P/2mov/P_2mov_pos6_neutr.png");
			}		
		}	
	}else if(oefen[i].aantal == 3){
		if(oefen[i].vinger == wijs_oefen){
			if(oefen[i].pos == 1){
				map = ts5_read_bitmap("Stimuli/W/3mov/W_3mov_pos1_neutr.png");
			}else if(oefen[i].pos == 2){
				map = ts5_read_bitmap("Stimuli/W/3mov/W_3mov_pos2_neutr.png");
			}else if(oefen[i].pos == 3){
				map = ts5_read_bitmap("Stimuli/W/3mov/W_3mov_pos3_neutr.png");
			}else if(oefen[i].pos == 4){
				map = ts5_read_bitmap("Stimuli/W/3mov/W_3mov_pos4_neutr.png");
			}		
		}else{
			if(oefen[i].pos == 1){
				map = ts5_read_bitmap("Stimuli/P/3mov/P_3mov_pos1_neutr.png");
			}else if(oefen[i].pos == 2){
				map = ts5_read_bitmap("Stimuli/P/3mov/P_3mov_pos2_neutr.png");
			}else if(oefen[i].pos == 3){
				map = ts5_read_bitmap("Stimuli/P/3mov/P_3mov_pos3_neutr.png");
			}else if(oefen[i].pos == 4){
				map = ts5_read_bitmap("Stimuli/P/3mov/P_3mov_pos4_neutr.png");
			}			
		}	
	}else if(oefen[i].aantal == 4){
		if(oefen[i].vinger == wijs_oefen){
			map = ts5_read_bitmap("Stimuli/W/4mov/W_4mov_neutr.png");
		}else{
			map = ts5_read_bitmap("Stimuli/P/4mov/P_4mov_neutr.png");
		}	
	}
	
	ts5_draw_scaled_bitmap(map, 1.50, 1.50, 0, 0);
