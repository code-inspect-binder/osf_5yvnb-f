...
//TEST OR EXPERIMENT
	...
	if(code == 1){
		...
		int portnum = ts5_define_serialport_response_input("COM4");
...
//INSTRUCTIES DEEL 1
	...
	ts5_printf(0, ay(0), "Tegelijk zal je 4 handen op het scherm zien waarvan 1, 2, 3, of 4 handen een beweging zullen maken");	
	ts5_printf(0, ay(-0.1), "De handen zullen je helpen bij het uitvoeren van je taak");	
	ts5_printf(0, ay(-0.2), "Ze zullen namelijk altijd de actie uitvoeren die jij ook moet uitvoeren");
...
//INSTRUCTIES
	...
	ts5_printf(0, ay(0.1), "De handen op het scherm zullen je helpen bij je taak");
