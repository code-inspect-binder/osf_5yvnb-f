...
//INSTRUCTIES DEEL 1
	...
	ts5_printf(0, ay(0.3), "In dit experiment zal je vier handen op het scherm zien");
	ts5_printf(0, ay(0.2), "Deze handen zullen ofwel de wijsvinger bewegen ofwel de pink bewegen");	
	ts5_printf(0, ay(0.1), "Tegelijkertijd zal je de letter W of de letter P zien verschijnen in het midden van het scherm");
	
	ts5_printf(0, ay(-0.1), "Jouw taak is om te reageren op de letter");		    
	ts5_printf(0, ay(-0.2), "Dit doe je door je wijsvinger opzij te bewegen als je de W ('wijsvinger') ziet");
	ts5_printf(0, ay(-0.3), "En door je pink opzij te bewegen als je de P ('pink') ziet");
...
//INSTRUCTIES
	...
	ts5_printf(0, ay(0.2), "Beweeg je wijsvinger opzij als je de W ('wijsvinger') ziet");
	ts5_printf(0, ay(0.1), "Beweeg je pink opzij als je de P ('pink') ziet");
